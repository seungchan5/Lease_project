...
<head>
    ...
    <script src="../../resources/js/Project_product_edit.js"></script>
    ...
    <script src="../../resources/js/Edit_Calendar.js"></script>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
</head>
<%@include file="../includes/Project_header.jsp" %>
<body>
<form:form modelAttribute="productRequest" action="/products/${productId}/edit" method="post" enctype="multipart/form-data">
<div class = "main">
    <h1>상품수정</h1>
    <h2>기본정보</h2>
    <hr>
    ...
    <div class = content>
        <div class='content_title'>
            <h3>제목 : </h3>
            <div>
                <form:input type="text" name="productName" id="" value="${productResponse.productName}" path="productName" cssErrorClass="errorsborder"/>
                <div class="errors">
        ...
        <div class='content_price'>
            <h3>가격 : </h3>
            <div>
                <form:input type="text" name="productPrice" value="${productResponse.productPrice}" path="productPrice" id="" cssErrorClass="errorsborder"/>
                <div class="errors">
        ...
        <div class='content_category'>
            ...
            <div>
                ...
                <form:select name="categoryId" path="categoryId" class="category_second">
                    <form:option value="" label="선택해주세요."/>
                	<c:if test="${productRequest.categoryId3 == '1'}">
   					 ...
   					 <c:if test="${productRequest.categoryId3 == '2'}">
   					 ...
   					 <c:if test="${productRequest.categoryId3 == '3'}">
   					 ...
   					 <c:if test="${productRequest.categoryId3 == '4'}">
        ...
        <div class='content_region'>
            ...
            <div>
                ...
                <form:select name="region2" path="region2" class="region_second">
                    <form:option value="" label="선택해주세요."/>
                	<c:if test="${productRequest.region1.equals('서울특별시')}">
   					 ...
   					 <c:if test="${productRequest.region1.equals('인천광역시')}">
     				   <form:option value="중구" label="중구"/>
   					 ...
   					 <c:if test="${productRequest.region1.equals('경기도')}">
        ...
        <div class='content_date'>
            ...
            <div class="subCalBox">
                ...
                <aside class="enabledBox">
                	<c:if test="${productResponse.rentDates !=null}">
                		<c:forEach var="index" begin="0" end="${productResponse.rentDates.size()-1}">
                	 		<c:set var="startDate" value="${productResponse.rentDates[index].rentAbleStartDate}" />
    				 		<c:set var="endDate" value="${productResponse.rentDates[index].rentAbleEndDate}" />
                			<aside class="enabledDate">
                				<span>${startDate} ~ ${endDate}</span>
                					...
                					<form:input type="text" name="rentAbleStartDate" path="rentAbleStartDate" class="subStartDate" value="${startDate}" hidden="true"/>
                					<form:input type="text" name="rentAbleEndDate" path="rentAbleEndDate" class="subEndDate" value="${endDate}" hidden="true"/>
                			</aside>
                		</c:forEach>
                	</c:if>
                	<c:if test="${productRequest.rentAbleStartDate !=null}">
                		<c:forEach var="index" begin="0" end="${productRequest.rentAbleStartDate.size()-1}">
	                		<c:set var="startDate" value="${productRequest.rentAbleStartDate[index]}" />
	    				 	<c:set var="endDate" value="${productRequest.rentAbleEndDate[index]}" />
	                		<aside class="enabledDate">
	                				<span>${startDate} ~ ${endDate}</span>
	                					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="subCalendar_cancel">
	                						<path d="M376.6 84.5c11.3-13.6 9.5-33.8-4.1-45.1s-33.8-9.5-45.1 4.1L192 206 56.6 43.5C45.3 29.9 25.1 28.1 11.5 39.4S-3.9 70.9 7.4 84.5L150.3 256 7.4 427.5c-11.3 13.6-9.5 33.8 4.1 45.1s33.8 9.5 45.1-4.1L192 306 327.4 468.5c11.3 13.6 31.5 15.4 45.1 4.1s15.4-31.5 4.1-45.1L233.7 256 376.6 84.5z"></path>
